                    ...
                    if eventId == 'deleted':
                        ...
                        if (eventId == 'documentMoved' and remote_parent_factory == COLLECTION_SYNC_ROOT_FACTORY_NAME):
                            ...
                            if (doc_pair.remote_state == 'synchronized' and doc_pair.remote_digest == new_info.digest and
                                    (eventId == 'documentCreated' or eventId == 'documentModified') and new_info.uid == doc_pair.remote_ref):
                                # Ignore the documentCreated / documentModified echos from server if the digest matches
